...
public interface EventProvider<L> extends DataModelLink
{
	...
	/**
	 * This method is called just before the event is sent. This allows the provider to modify the actual object data before it is sent.
	 * The final object to be sent must then be returned.<br/>
	 ...
	 * @return See desc.
	 */
	public SIFEvent<L> modifyBeforePublishing(SIFEvent<L> sifEvent, SIFZone zone, SIFContext context);
