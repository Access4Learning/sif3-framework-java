...
public interface FunctionalServiceConsumer extends Consumer
{
    /**
    ...
    List<Response> createToPhase(String resourceID, String phaseName, String payload,
            MediaType requestMediaType, MediaType responseMediaType,
            List<ZoneContextInfo> zoneCtxList, CustomParameters customParameters) throws ServiceInvokationException;
     ...
     *             Any underlying errors occurred such failure to invoke actual web-service etc.
     */
    List<Response> createToState(String resourceID, String phaseName, SIF3PhaseState state,
            List<ZoneContextInfo> zoneCtxList) throws ServiceInvokationException;
