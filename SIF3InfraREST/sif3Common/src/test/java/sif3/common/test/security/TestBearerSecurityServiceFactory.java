...
public class TestBearerSecurityServiceFactory
{
    ...
    public TestBearerSecurityServiceFactory()
    {
...
//                TokenInfo tokenInfo = service.generateToken(coreInfo, properties.getPropertyAsString("env.pwd", null));
    ...
    {
        TestBearerSecurityServiceFactory tester = new TestBearerSecurityServiceFactory();
