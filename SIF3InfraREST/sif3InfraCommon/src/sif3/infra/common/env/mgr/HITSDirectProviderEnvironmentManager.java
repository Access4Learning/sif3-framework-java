/*
 * HITSDirectProviderEnvironmentManager.java 
 * 
 * Created: 18/09/2013
 * 
...
import sif3.infra.common.env.ops.HITSDirectProviderEnvStoreOps;
 ...
 * @author Joerg Huber
 */
public class HITSDirectProviderEnvironmentManager implements EnvironmentManager
{
	...
	private HITSDirectProviderEnvStoreOps envOps = null;
	...
	private static HITSDirectProviderEnvironmentManager instance = null;
	 ...
	 */
	public static HITSDirectProviderEnvironmentManager initialse(String adapterFileNameWithoutExt)
	{
		if (instance == null)
		{
			instance = new HITSDirectProviderEnvironmentManager(adapterFileNameWithoutExt);
		}
	 ...
	 * @return See Desc.
	 */
	public static HITSDirectProviderEnvironmentManager getInstance()
	{
		return instance;
	}
	...
	/*-- Private methods --*/
	/*---------------------*/
	private HITSDirectProviderEnvironmentManager(String adapterFileNameWithoutExt)
	{
		super();
		this.adapterFileNameWithoutExt = adapterFileNameWithoutExt;
		this.envOps = new HITSDirectProviderEnvStoreOps(adapterFileNameWithoutExt);
	}
