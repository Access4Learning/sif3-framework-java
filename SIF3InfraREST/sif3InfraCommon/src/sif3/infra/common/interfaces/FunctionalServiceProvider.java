...
public interface FunctionalServiceProvider extends EventProvider<JobCollectionType>, Provider
{
     ...
     * @return a string to be returned to the consumer.
     */
    StateType createToState(String resourceID, String phaseName, Object data, SIFZone zone,
            SIFContext context, RequestMetadata metadata, ResponseParameters customResponseParams)
            throws SIF3Exception;
     ...
     */
    void sendJobEvent(JobType job, EventAction action, SIFZone zone, SIFContext context);
     ...
     *            The context the operation occurred in
     */
    void sendJobEvent(JobType job, String phaseName, EventAction action, SIFZone zone,
            SIFContext context);
