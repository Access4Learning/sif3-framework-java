...
import systemic.sif3.infra.common.model.Environment;
import systemic.sif3.infra.common.model.Environment.ApplicationInfo;
import systemic.sif3.infra.common.model.ObjectFactory;
import systemic.sif3.infra.common.model.ProductIdentityType;
...
public class EnvironmentDemo
{
	  ...
	  private static String getEnvironmentAsXML(Environment env)
	  {
	...
	{
		Environment env = objFactory.createEnvironment();
