/*
 * StudentConsumerService.java Created: 16/05/2014 Copyright 2014 Systemic Pty
...
/**
 * This is a basic Consumer Service that just starts up and if events are
 * enabled will start processing events. It must be run from the command line
 * and will block until CTRL-C is pressed. In that case it will shut down and
 * quit.<br/>
 * <br/>
 * The intend of this class is to illustrate how a stand-alone consumer service
 * could be implemented and started.
 */
public class ConsumerService {

	private static void usage(String[] args) {
		System.out.println("Usage <JAVA_HOME>/bin/java <JVM_SETTINGS> -cp <classpath> systemic.sif3.demo.uk.rest.consumer.StudentConsumerService <serviceID> <consumer.properties>");
