/*
 * AUDataModelProviderWithEvents.java Created: 19/03/2014 Copyright 2014
 * Systemic Pty Ltd Licensed under the Apache License, Version 2.0 (the
...
public abstract class UKDataModelProviderWithEvents<L> extends BaseEventProvider<L> {
	 ...
	 * (non-Javadoc)
	 * @see
	 * sif3.infra.rest.provider.BaseProvider#getCustomServiceInfo(sif3.common.
