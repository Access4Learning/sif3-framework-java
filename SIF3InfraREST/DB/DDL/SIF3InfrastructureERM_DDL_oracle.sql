...
CREATE  TABLE SIF3_SESSION (
  ...
  CONSUMER_NAME VARCHAR2(100) NULL ,
  SOLUTION_ID VARCHAR2(100) NULL ,
  APPLICATION_KEY VARCHAR2(100) NOT NULL ,
  USER_TOKEN VARCHAR2(200) NULL ,
  INSTANCE_ID VARCHAR2(200) NULL ,
  PASSWORD VARCHAR2(100) NULL ,
  SESSION_TOKEN VARCHAR2(200) NULL ,
  ENVIRONMENT_ID VARCHAR2(36) NULL ,
  FINGERPRINT VARCHAR2(255) NULL ,
  SECURITY_TOKEN VARCHAR2(1000) NULL,
  SECURITY_TOKEN_EXPIRY TIMESTAMP NULL,
  ADAPTER_TYPE VARCHAR2(20) ,
  ENVIRONMENT_XML CLOB NULL ,
  QUEUE_STRATEGY VARCHAR2(20) NULL ,
...
CREATE  TABLE SIF3_QUEUE (
  ...
  QUEUE_TYPE VARCHAR2(10) NOT NULL,
  ...
  MESSAGE_URI VARCHAR2(256) NOT NULL ,
  WAKUP_URI VARCHAR2(256) NULL ,
...
CREATE TABLE SIF3_EXT_SECURITY_SERVICE (
  ...
  TWO_PHASE CHAR NOT NULL DEFAULT 'N',
