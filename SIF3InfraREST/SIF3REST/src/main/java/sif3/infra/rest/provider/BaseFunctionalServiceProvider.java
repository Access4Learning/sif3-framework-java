    ...
    */
    ...
    public void broadcastEvents()
    {
        ...
        try
        {
            ...
            EventClient evtClient = new EventClient(envMgr, getInfraRequestPayloadMetadata(), getInfraResponsePayloadMetadata(), serviceName, getMarshaller(), getCompressionEnabled());
