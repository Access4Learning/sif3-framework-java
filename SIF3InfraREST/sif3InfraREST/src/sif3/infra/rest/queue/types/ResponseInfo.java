...
/**
 * This class is a utility type to allow a consumer to package the actual RESPONSE data and related
 ...
 * way an RESPONSE can easily be passed between classes and processed without having the need of many
 ...
 *
 */
public class ResponseInfo extends DelayedBaseInfo implements Serializable
{
    private static final long serialVersionUID = 3081545487382654078L;
}
