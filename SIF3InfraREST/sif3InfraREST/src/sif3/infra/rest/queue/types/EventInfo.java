...
public class EventInfo implements Serializable
{
  ...
  private EventMetadata eventMetadata; // metadata of event generated by provider of event
  ...
  {
    this(eventPayload, mediaType, null, null, null, null, null, null);
  }

  public EventInfo(String eventPayload, MediaType mediaType, EventAction eventAction)
  {
    this(eventPayload, mediaType, eventAction, null, null, null, null, null);
  }

  public EventInfo(String eventPayload, MediaType mediaType, EventAction eventAction, UpdateType updateType)
  {
    this(eventPayload, mediaType, eventAction, updateType, null, null, null, null);
  }
  ...
  {
    this(eventPayload, mediaType, eventAction, updateType, zone, context, null, null);
  }

  public EventInfo(String eventPayload, MediaType mediaType, EventAction eventAction, UpdateType updateType, SIFZone zone, SIFContext context, EventMetadata eventMetadata)
  {
	  this(eventPayload, mediaType, eventAction, updateType, zone, context, eventMetadata, null);	  
  }
  
  public EventInfo(String eventPayload, MediaType mediaType, EventAction eventAction, UpdateType updateType, SIFZone zone, SIFContext context, EventMetadata eventMetadata, String messageQueueReaderID)
  {
    super();
  ...
  public void setEventMetadata(EventMetadata eventMetadata)
  {
	...
	{
		return "EventInfo [eventPayload=" + this.eventPayload + ", eventAction=" + this.eventAction
		        + ", updateType=" + this.updateType + ", metadata=" + this.metadata
		        + ", mediaType=" + this.mediaType + ", zone=" + this.zone + ", context="
		        + this.context + ", eventMetadata=" + this.eventMetadata
		        + ", messageQueueReaderID=" + this.messageQueueReaderID + "]";
	}
}
