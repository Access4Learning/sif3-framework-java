...
public class SubscriptionClient extends BaseClient
{
	...
	public Response getSubscriptions() throws ServiceInvokationException
	{
		...
		try
		{
			...
			return setResponse(service, clientResponse, SubscriptionCollectionType.class, hdrProperties, null, null, Status.OK, Status.NOT_MODIFIED, Status.NO_CONTENT);
		}
		catch (Exception ex)
		{
	...
	public Response getSubscription(String subscriptionID) throws ServiceInvokationException
	{
		...
		try
		{
			...
			return setResponse(service, clientResponse, SubscriptionType.class, hdrProperties, null, null, Status.OK, Status.NOT_MODIFIED, Status.NO_CONTENT);
		}
		catch (Exception ex)
		{
	...
	public Response subscribe(SubscriptionType subscriptionInfo) throws ServiceInvokationException
	{
		...
		try
		{
			...
			return setResponse(service, clientResponse, SubscriptionType.class, hdrProperties, null, null, Status.CREATED, Status.CONFLICT);
		}
		catch (Exception ex)
		{
