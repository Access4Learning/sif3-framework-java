 ...
 *         &lt;element name="ListedStatus" type="{http://www.sifassociation.org/au/datamodel/1.3}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Type" use="required" type="{http://www.sifassociation.org/au/datamodel/1.3}AUCodeSetsTelephoneNumberTypeType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "PhoneNumberType", namespace = "http://www.sifassociation.org/au/datamodel/1.3", propOrder = {
    "number",
    "extension",
    "listedStatus"
})
...
public class PhoneNumberType {
    ...
    @XmlElementRef(name = "Extension", namespace = "http://www.sifassociation.org/au/datamodel/1.3", type = JAXBElement.class, required = false)
    protected JAXBElement<String> extension;
    @XmlElementRef(name = "ListedStatus", namespace = "http://www.sifassociation.org/au/datamodel/1.3", type = JAXBElement.class, required = false)
