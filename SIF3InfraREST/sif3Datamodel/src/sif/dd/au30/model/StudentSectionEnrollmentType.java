...
@XmlType(name = "StudentSectionEnrollmentType", namespace = "http://www.sifassociation.org/au/datamodel/1.3", propOrder = {
...
public class StudentSectionEnrollmentType {
    ...
    @XmlElement(name = "SectionInfoRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.3")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    @XmlElementRef(name = "EntryDate", namespace = "http://www.sifassociation.org/au/datamodel/1.3", type = JAXBElement.class, required = false)
